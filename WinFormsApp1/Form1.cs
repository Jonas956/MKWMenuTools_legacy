...
namespace WinFormsApp1
{
    public partial class MKWMenuTools : MetroSetForm
    {
        ...
        private void btnImageBGMenuSingle_Click(object sender, EventArgs e)  //Image BG MenuSingle
        {
            ...
            strStaticMenuSingle = "/c rename-item .\\Images\\MenuSingle\\BG.png BG.tpl.png; wimgt encode .\\Images\\MenuSingle\\BG.tpl.png; copy .\\Images\\MenuSingle\\BG.tpl .\\SZS\\MenuSingle.d\\bg\\timg\\; xcopy /Y /E .\\Patches\\MenuSingle\\StaticBGPatch\\ .\\SZS\\MenuSingle.d";
        ...
        private void btnTevStage_Click(object sender, EventArgs e)
        {
            ...
            strRaceTevStage = "/c wszst ex .\\SZS\\" + strRaceX + ".szs;" +
             ...
             "xcopy /Y /E .\\Patches\\Race\\TevStage\\Race\\ .\\SZS\\Race.d";
        ...
        private void ImageBGMenuMulti_Click(object sender, EventArgs e)
        {
            ...
            strStaticMenuMulti = "/c rename-item .\\Images\\MenuMulti\\BG.png BG.tpl.png; wimgt encode .\\Images\\MenuMulti\\BG.tpl.png; copy .\\Images\\MenuMulti\\BG.tpl .\\SZS\\MenuMulti.d\\bg\\timg\\; xcopy /Y /E .\\Patches\\MenuMulti\\StaticBGPatch\\ .\\SZS\\MenuMulti.d; pause";
        ...
        private void btnImageBGMenuOther_Click(object sender, EventArgs e)
        {
            ...
            strStaticMenuOther = "/c wimgt encode .\\Images\\MenuOther\\BG.tpl.png; pause";
            //strStaticMenuOther = "/c rename-item .\\Images\\MenuOther\\BG.png BG.tpl.png; wimgt encode .\\Images\\MenuOther\\BG.tpl.png; copy .\\Images\\MenuOther\\BG.tpl .\\SZS\\MenuOther.d\\bg\\timg\\; xcopy /Y /E .\\Patches\\MenuOther\\StaticBGPatch\\ .\\SZS\\MenuOther.d; pause";
        ...
        private void btnLECODEtpl_Click(object sender, EventArgs e) //Extract CT Icons for the LECode Patch
        {
            string strLEICONS;

            strLEICONS = "/c wszst ex .\\SZS\\LECode.szs;" +
                "xcopy /Y /E .\\SZS\\LeCode.d\\button\\timg\\ct_icons.tpl .\\Patches\\MenuSingle\\LECodePatch\\button\\timg;" +
                "xcopy /Y /E .\\SZS\\LeCode.d\\button\\timg\\ct_icons.tpl .\\Patches\\MenuSingle\\LECodePatch\\control\\timg;" +
                "xcopy /Y /E .\\SZS\\LeCode.d\\button\\timg\\ct_icons.tpl .\\Patches\\MenuMulti\\LECodePatch\\button\\timg;" +
                "xcopy /Y /E .\\SZS\\LeCode.d\\button\\timg\\ct_icons.tpl .\\Patches\\MenuMulti\\LECodePatch\\control\\timg";

            System.Diagnostics.Process.Start("powershell.exe", strLEICONS);
        }

        private void btnLECODEtpl_MouseHover(object sender, EventArgs e)
        {
          
         lblDesc.Text = "This will extract the ct_icons.tpl from your base LECode MenuSingle. Place it under SZS/LECode.szs!";
        }
